<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="CRUD.aspx.cs" Inherits="_02_Crud_webForm_AspNet_4_7_PaginaMaestra.Page.CRUD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <form runat="server" class="h-100 d-flex align-items-center justify-content-center">
        ...
        <div class="mb-3">
            ...
            <asp:TextBox runat="server" TextMode="Date" CssClass="form-control" Visible="true" ID="tbdate"></asp:TextBox>
            <asp:TextBox runat="server" TextMode="DateTime" CssClass="form-control" Visible="false" ID="tbdateR"></asp:TextBox>
        </div>
