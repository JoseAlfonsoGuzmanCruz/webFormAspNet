...
namespace _02_Crud_webForm_AspNet_4_7_PaginaMaestra.Page
{
    public partial class CRUD : System.Web.UI.Page
    {
        ...
        void CargarDatos()
        {
            ...
            tbdateR.Text = d.ToString("dd/MM/yyyy");
            con.Close();
        }
        ...
        protected void BtnCreate_Click(object sender, EventArgs e)
        {
            ...
            //cmd.Parameters.Add("@fecha", SqlDbType.Date).Value=Convert.ToDateTime(tbdate.Text);
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add("@edad", SqlDbType.Int).Value = tbedad.Text;
            cmd.Parameters.Add("@correo", SqlDbType.VarChar).Value = tbemail.Text;
            cmd.Parameters.Add("@fecha", SqlDbType.Date).Value = Convert.ToDateTime(tbdateR.Text);//correjir
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("Index.aspx");
        }
